...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    ...
    >
      <div
        ref={cardRef}
        className="group bg-secondary rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 ease-out hover:shadow-gold"
          ...
          <div className="absolute top-2 right-2 flex flex-col space-y-2">
            <motion.button 
              ...
              className={`p-2 rounded-full transition-colors ${
                isWishlisted ? 'bg-primary text-dark' : 'bg-dark/50 text-light hover:bg-primary hover:text-dark'
              }`}
